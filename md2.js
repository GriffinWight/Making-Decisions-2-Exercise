...
//Code Here
console.log('My favorite numbers are:',myFavoriteNumbers, '\n')
...
console.log('My favorite numbers all added together is equal to',arrayTotal, '\n');

someNum = (arrayTotal / 5)
console.log('That number divided by five is',someNum)
